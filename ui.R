...
body <- dashboardBody(
 ...
 N’hésitez pas à nous faire part de vos impressions (rubrique « Contactez-nous ») afin d’apporter des améliorations et ce pour votre plus grand confort :)"),
                                             ...
                                             h4("Code source:"),
                                             p("Le code shiny pour créer cette application est disponible sur mon github :"),
                                             a("https://github.com/AurelienCallens/Aliexpress_dashboard", href="https://github.com/AurelienCallens/Aliexpress_dashboard")
                    ...
                    tabPanel("En",
                             fluidRow(column(width=12,
                                             ...
                                             h4("Source code:"),
                                             p("Shiny code for this dashboard is available on my github repository :"),
                                             a("https://github.com/AurelienCallens/Aliexpress_dashboard", href="https://github.com/AurelienCallens/Aliexpress_dashboard")
                             ))
